...
Книга рассматривает агентные системы как governed production systems, у которых должны быть:
...
- различать rollout, response, lineage и accountability как разные operational функции.
