...
- версия контракта непрерывности и доказательства: [схема непрерывности контекста](continuity-envelope-schema.md), контракты событий `context_compaction`/`context_rehydration`, результаты сравнения полной и сжатой истории и правило повторной авторизации каждого вызова возможности после восстановления.
