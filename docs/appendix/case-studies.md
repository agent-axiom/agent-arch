...
Если тебе нужны не сценарии, а reusable policy artifacts, переходи на страницу [шаблонов политик](policy-templates.md). Если интересует, что еще стоит добавить в книгу дальше, это уже про [дорожную карту для сообщества](community-roadmap.md).
