...
Ниже собраны основные первоисточники, на которые опирается текущая версия книги. Дата последней редакционной проверки источников: **26 июня 2026 года**.
...
- Cloudflare Agents SDK, [Workflows](https://developers.cloudflare.com/agents/concepts/workflows/), [Durable execution](https://developers.cloudflare.com/agents/api-reference/durable-execution/) и [Durable execution with fibers](https://developers.cloudflare.com/agents/runtime/execution/durable-execution/)
