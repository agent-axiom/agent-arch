...
`check-controls` now also breaks out `failed_run_controls`, so trace/provenance-related control gaps can be reviewed separately from generic control hygiene.
