...
- OpenAI Agents SDK, [Sandbox Agents](https://openai.github.io/openai-agents-python/sandbox_agents/) 与 [Sandbox Concepts](https://openai.github.io/openai-agents-python/sandbox/guide/)
