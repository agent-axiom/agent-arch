...
下面收录的是本书当前版本依赖的主要一手来源。最近一次来源编辑审查：**2026 年 6 月 26 日**。
...
- Cloudflare Agents SDK, [Workflows](https://developers.cloudflare.com/agents/concepts/workflows/)、[Durable execution](https://developers.cloudflare.com/agents/api-reference/durable-execution/) 与 [Durable execution with fibers](https://developers.cloudflare.com/agents/runtime/execution/durable-execution/)
