...
- может ли рабочий агент запросить дополнительные возможности или работает только с ограниченным набором;
- должен ли результат рабочего агента пройти ревью до того, как будет выполнена любая пишущая возможность.
