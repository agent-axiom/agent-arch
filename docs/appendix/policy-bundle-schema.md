...
- [Сквозная цепочка доказательств: от запроса к решению о поэтапном выпуске](../book/part-v/evidence-spine.md)
...
- может ли запуск остановиться в ожидании, возобновиться, завершиться по времени ожидания или быть отменен;
...
Если среда исполнения уже обращается с наборами как с управляемыми поверхностями выпуска, неизбежно появляется и следующий вопрос:
...
- может ли исполняющий агент запросить дополнительные возможности или работает только с ограниченным набором возможностей;
- должен ли результат работы исполнителя пройти проверку до того, как будет выполнена любая записывающая возможность.
