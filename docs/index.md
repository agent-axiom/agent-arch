...
После этой книги читатель должен перестать мыслить агент как “LLM плюс немного оркестрации” и начать мыслить его как governed production system:
...
- Полная русская рукопись с переводами `en` и `zh`.
- Восемь частей книги: от архитектурных оснований до жизненного цикла системы.
