...
- он не заменяет reader journey самой книги;
- он не объясняет основной causal argument главу за главой;
- он не должен быть главным местом, где читатель учит trade-offs и границы между слоями.
