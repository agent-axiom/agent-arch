...
| `docs/companion/artifacts/eval-failed-run-timeout.json` | `uv run python -m agent_runtime_ref export-eval-dataset --scenario failed_run_timeout --output docs/companion/artifacts/eval-failed-run-timeout.json` | Regression dataset seed for failed-run timeout and duplicate-ticket guard review. |
