...
Как читать эту главу. Ориентир главы: в фокусе здесь не набор чисел и не отдельный тест, а решение о выпуске. Глава показывает, как оценочный набор, контракт проверяющего, регрессионный шлюз и шлюз поэтапного выпуска складываются в один проверяемый договор между командой и системой. Такой договор должен помещаться на одной странице выпускного решения и оставаться понятным участникам проверки без внешних пояснений.
...
**Листинг 32. Минимальный контракт возможности.** Тип: декларативная конфигурация; полный учебный контракт приведен ниже.

**Как читать листинг.** Сопоставьте владельца, риск, входы, выходы и принципал: отсутствие любого поля ослабляет границу возможности.
...
**Листинг 37. Как запустить.** Тип: структурированный результат; полный учебный контракт приведен ниже.
...
**Листинг 38. Контрактные примеры.** Тип: декларативная конфигурация; полный учебный контракт приведен ниже.
