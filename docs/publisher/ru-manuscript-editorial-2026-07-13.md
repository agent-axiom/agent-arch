...
**Листинг 8. Решение о долговременной записи памяти.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iii/chapter-5.md`.
...
**Листинг 9. Маршрутизация записи памяти.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iii/chapter-6.md`.
...
**Листинг 10. Ранжирование памяти перед сборкой подсказки.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iii/chapter-7.md`.
...
**Листинг 11. Контролируемое выполнение инструмента.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iv/chapter-8.md`.
...
**Листинг 12. Диспетчеризация возможности по контракту.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iv/chapter-9.md`.
...
**Листинг 13. Разделение вызова инструмента и передачи задачи агенту.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iv/practical-mcp-a2a.md`.
...
**Листинг 14. Решение о повторе после внешнего эффекта.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-iv/chapter-10.md`.
...
**Листинг 15. Запись результата шага в трассу.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-v/chapter-11.md`.
...
**Листинг 16. Классификация здоровья запуска.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-v/chapter-12.md`.
...
**Листинг 17. Регрессионный шлюз оценки.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-v/chapter-13.md`.
...
**Листинг 24. Проверка записи реестра.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-viii/chapter-27.md`.
...
**Листинг 18. Классификация риска изменения.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-viii/chapter-20.md`.
...
**Листинг 21. Проверка доверенного артефакта.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-viii/chapter-22.md`.
...
**Листинг 23. Проверка покрытия наблюдаемостью.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-viii/chapter-26.md`.
...
Предыдущая глава определила, какие сигналы позволяют заметить отклонение поведения и разрыв между реестром и фактическим исполнением. Теперь фокус смещается на более трудный вопрос: что происходит, когда исполнитель способен искать путь вокруг уже заданного ограничения.
...
**Листинг 19. Проверка неизменности действия перед побочным эффектом.** Тип:
...
**Листинг 20. Решение об аварийном реагировании.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-viii/chapter-21.md`.
...
**Листинг 22. Проверка готовности к замене.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-viii/chapter-23.md`.
...
**Листинг 25. Контрольные точки оркестратора.** Тип: псевдокод;
...
**Листинг 26. Долговечный запуск и продолжение выполнения.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-vii/chapter-16.md`.
...
**Листинг 27. Принудительный путь от предложения модели к исполнению.** Тип:
...
**Листинг 28. Симметричные перехватчики вокруг решения политики.** Тип:
...
**Листинг 29. Состав отпечатка подтверждаемого действия.** Тип:
...
**Листинг 30. Проверка готовности к поэтапному выпуску.** Тип: синтаксически проверяемый учебный пример; источник: `docs/book/part-vii/chapter-18.md`.
