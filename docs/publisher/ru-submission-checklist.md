...
contains Introduction and Parts I-VII rough assembly, but appendices, compression
and final editorial passes are still pending.**
...
- [ ] Google Doc contains the full manuscript body including appendices, not only
