...
Status: актуальная карта полнообъемной сборки на 2026-07-11. Репозиторий
...
- редакционный источник:
  `docs/publisher/ru-manuscript-world-class-2026-07-11.md`;
...
- часть `docs/book/part-viii/chapter-24.md`
