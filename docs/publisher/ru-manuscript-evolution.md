...
На 2026-07-29 существующий Google Doc является полнообъёмной рабочей
...
Каноническая последовательность из 8820 непустых абзацев полностью подтверждена
итоговым чтением Google Doc. Оставшиеся ограничения относятся не к объёму
...
- текущая проверенная вёрстка: 453 страницы Google-ориентированной производной
  и 327 страниц производной `Template2000n`.
