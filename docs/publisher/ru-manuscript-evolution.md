...
### 2026-08-17. Редакционный проход по стандартам технической литературы

Статус: канонический Markdown, существующий Google Doc и обе издательские
производные синхронизированы и проверены.

Реализовано:

- упрощены плотные переходы и длинные фразы в главах 4, 5, 11, 15, 24, 26 и
  28 без ослабления нормативных контрактов;
- устранены избыточный англицизм и повтор требования о владельце сигнала;
- листинги 32-34 дополнены ожидаемым результатом, сигналом ошибки и
  архитектурным смыслом;
- исправлено расхождение между заявленным числом обязательных блоков
  платформы и фактическим перечнем;
- введено правило трёх классов обновлений: стабильный инвариант, датированный
  снимок технологии и исполняемая деталь Online Companion;
- 13 адресных изменений перенесены в существующий Google Doc одним пакетом из
  124 операций с контролем исходной ревизии;
- обратное чтение подтвердило 8 760 из 8 760 целевых абзацев; сохранены 57
  изображений, их альтернативные описания и 12 таблиц.

Метрики:

- приблизительно 95 028 слов;
- Google-ориентированная производная: 466 страниц;
- производная `Template2000n`: 345 страниц;
- пустых страниц и замечаний проверки доступности нет;
- 1 347 тестов и 21 чистый запуск лабораторных команд успешны;
- строгая сборка трёх локализаций успешна;
- финальная ревизия Google Doc:
...
- `docs/publisher/ru-technical-book-polish-pass-2026-08-17.md`.
