...
- редакционный источник: `docs/publisher/ru-manuscript-world-class-2026-07-11.md`;
- точный снимок финальной Google Doc-ревизии:
...
- структура: 7 частей, 27 глав, приложения;
- учебный контур: 7 лабораторных работ и итоговый проект;
- визуальный контур: 25 пронумерованных рисунков и две нативные таблицы Google Docs;
- объем контрольного экспорта: около 99 000 слов и 450 страниц;
...
Издательская рукопись собирается как отдельный слой: 7 частей, 27 глав,
...
глав 1-27 зафиксирована в `docs/publisher/ru-source-map.md` и каноническом
