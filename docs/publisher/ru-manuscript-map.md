...
- объем контрольного экспорта: около 98 000 слов; точное число страниц зависит
  от raw-экспорта Google Docs и производной Template2000n;
...
Издательская рукопись собирается как отдельный слой: 7 частей, 28 глав,
