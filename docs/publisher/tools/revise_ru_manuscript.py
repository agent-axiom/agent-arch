...
TEXT_REPLACEMENTS = {
    ...
    "Если вам нужно увидеть, как это управляемое решение политики дальше связывается с трассами, подтверждениями, оценочными суждениями, инцидентами и поэтапным выпуском, откройте отдельную страницу Сквозная цепочка доказательств.": "Дальнейшие главы свяжут это решение политики с трассами, подтверждениями, оценками, инцидентами и поэтапным выпуском в единую цепочку доказательств.",
