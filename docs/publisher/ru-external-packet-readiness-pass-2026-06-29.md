...
Status: clean working package for trusted editorial review; not final publisher
submission.
...
The current package is suitable for a trusted editor who understands that the
manuscript is still in pre-author-finalization state:
...
Do not send as final publisher submission until:
