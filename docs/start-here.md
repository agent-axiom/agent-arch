...
Агентов строить скучно, но результат ошеломляющий: дисциплина вокруг границ доверия, трасс, согласований и поэтапного выпуска превращает демо в систему, которую можно безопасно улучшать.
...
- [Глава 20. Управление изменениями для агентных систем](book/part-viii/chapter-20.md)
