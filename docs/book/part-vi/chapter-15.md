...
- shared gateways убирают повторяющиеся критичные ошибки across teams;
...
Если большинство этих условий не выполняется, у организации уже могут быть platform assets, но реального anti-zoo operating model у нее пока нет.
