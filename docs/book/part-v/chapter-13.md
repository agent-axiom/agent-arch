...
!!! info "Нужны схемы и артефакты?"
    Если тебе нужен не только rationale, но и reusable contract layer, открой [схему трасс и каталог событий](../../appendix/trace-schema.md) и [схему eval datasets и grading contract](../../appendix/eval-schema.md).
