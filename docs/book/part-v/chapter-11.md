...
Именно поэтому наблюдаемость для агентных систем лучше начинать с traces, а не с надежды, что потом кто-нибудь разберется по grep.
...
Это особенно полезно для агентных систем, где один run может включать:
...
Без этого наблюдаемость быстро становится красивой, но не очень полезной.
