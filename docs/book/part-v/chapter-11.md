...
## 12. Что чаще всего ломается в наблюдаемости агентной системы
...
Если хочешь быстро проверить свою модель наблюдаемости, пройди по вопросам:
...
В этой же истории следующий шаг очень естественный: после того как команда научилась восстанавливать путь одного сбоя, нужно формализовать, что вообще считать "здоровой" системой каждый день. То есть перейти к SLO.
