...
- вызовы инструментов стали чаще ошибаться;
...
Очень частая ошибка: брать метрики отдельных частей и выдавать их за здоровье всей платформы.
