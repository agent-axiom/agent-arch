...
Это должно оставаться верным и для degraded paths. Failed-run drill полезен только тогда, когда та же цепочка по-прежнему объясняет, какая release identity управляла этим сбоем, какой trace его сохранил, какая конкретная причина сбоя осталась видимой, как он был graded и повлиял ли он на rollout judgment.
...
- какая конкретная причина сбоя сохранилась для degraded paths;
