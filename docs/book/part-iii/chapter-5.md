...
- артефакты выполнения вроде заметок трассировки или результатов инструментов.

Если все это складывается в одно место, очень быстро начинается хаос. Поэтому первое правило простое: не проектируй память как одно абстрактное хранилище. Проектируй ее как набор разных контуров с разным временем жизни, уровнем доверия и правилами записи.
...
Именно поэтому путь записи в память должен рассматриваться как чувствительный с точки зрения безопасности, а не как “техническая мелочь”.
...
Это не одно и то же. Если ты сохраняешь все это без маркировки происхождения, позже рантайм не сможет понять, что можно использовать как instruction-grade context, а что можно использовать только как reference.
