...
A minimal memory poisoning scenario should test the same memory poisoning review fields that later land in the [memory/retrieval schema](../../appendix/memory-retrieval-schema.en.md) and [trace schema](../../appendix/trace-schema.en.md):
