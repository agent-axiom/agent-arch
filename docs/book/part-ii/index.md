...
Следующий естественный шаг после этого контура — перейти в [Часть III](../part-iii/index.md) и решить, что агенту вообще разрешено помнить между runs, как retrieval возвращает контекст обратно и как не превратить память в новый источник риска.
