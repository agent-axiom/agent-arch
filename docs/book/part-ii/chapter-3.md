...
Полезная карта эшелонированной защиты — это не стена контролей, а короткая цепочка: где сбой должен быть остановлен и какое доказательство показывает, что слой сработал.
