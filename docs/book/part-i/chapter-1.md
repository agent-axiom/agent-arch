...
!!! info "Быстрый выбор: рабочий процесс, одиночный агентный цикл или многоагентная схема"
    Начинай с наименее динамичной формы, которая безопасно решает задачу.

    **Путь почти всегда известен заранее.** Начинай с обычного рабочего процесса: его дешевле сопровождать, проще тестировать и легче объяснять.

    **Нужен ограниченный выбор инструмента или следующего шага.** Используй одиночный агентный цикл: он дает гибкость без раннего взрыва сложности.

    **Есть независимые подзадачи, разные контексты и разные владельцы.** Только тогда думай про многоагентную схему: она разделяет ответственность и контекст, когда это разделение реально нужно.

Короткая текстовая формула: известный путь — рабочий процесс; ограниченный выбор следующего шага — одиночный агентный цикл; независимые подзадачи с разными владельцами — только тогда многоагентная схема.
