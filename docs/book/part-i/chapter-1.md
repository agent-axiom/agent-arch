...
Одна из самых полезных практических мыслей у Anthropic состоит в том, что на раннем этапе команде не стоит мыслить фреймворком по умолчанию.[^anthropic] Если задачу уже решают прямой вызов API и небольшой слой оркестрации, то лишняя абстракция почти всегда ухудшает отладку, inspect prompt-цепочки и operational ownership, а не улучшает их.
