...
Начинай с наименее динамичной формы, которая безопасно решает задачу. Эта рамка намеренно дана без таблицы: при экспорте в PDF, печать или поисковый индекс читатель должен увидеть не сетку, а ясное правило выбора.
