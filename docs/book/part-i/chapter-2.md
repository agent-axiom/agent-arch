...
- обучающий набор данных и reward model принадлежат к разработке и обучению модели, а не к рантайму;
...
Это различие кажется теоретическим, но на практике оно очень полезно. Если у команды начинает деградировать маршрутизация инструментов, путь подтверждения или дисциплина поиска, причина обычно живет в контуре рантайма, а не в UI или в reward model.
