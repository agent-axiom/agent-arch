...
4. Продолжать editorial cleanup на публичных entry surfaces и sample chapters.
5. Держать `.en` и `.zh` как читаемые draft translation layers, синхронизируя их после смысловых правок русского core.
