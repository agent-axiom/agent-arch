...
После этой части становится видно, как архитектура, безопасность, память, выполнение и наблюдаемость складываются в один operational skeleton. Дальше уже можно углубляться в lifecycle, кодовые примеры и редакторскую шлифовку.
