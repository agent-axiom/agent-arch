...
Свежий материал OpenAI полезен тем, что рассматривает background execution как first-class concern рантайма, а не как обход проблем с timeout.[^openai-background]
