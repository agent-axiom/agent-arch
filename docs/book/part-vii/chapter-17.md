...
Именно в этом состоит distinct promise этой главы. Она должна показать читателю, где на самом деле живет contract core рантайма и почему runnable system все еще остается незрелой, пока решения о допустимости, риске и capability control прячутся в orchestration code.
