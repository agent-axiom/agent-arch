...
Поэтому следующий обязательный слой опорной реализации - слой политик.
...
!!! info "Нужен контрактный слой?"
    Для более прикладной формы открой [схему policy bundle и approval contract](../../appendix/policy-bundle-schema.md), [схему approval request и decision record](../../appendix/approval-schema.md) и [опорный пакет](../../appendix/reference-package.md).
