...
Именно в этом состоит distinct promise этой главы. Она должна помочь читателю перейти еще через одну границу: от runnable governed system к системе, которую команда действительно может защищать в момент go/no-go.
