...
!!! info "Freshness note"
    ...
    What changed since the previous review: MCP security boundaries, tool-poisoning surfaces, A2A trust model, and publisher-readiness concerns now have concrete contract coverage and docs-surface guards.
