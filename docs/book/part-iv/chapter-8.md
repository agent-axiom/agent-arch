...
- Инструменты данных читают и возвращают контекст: проверка статуса, извлечение, чтение CRM;
- Инструменты действия меняют внешний мир: создать тикет, отправить письмо, обновить запись;
...
- Инструменты данных почти всегда ближе к инструментам чтения;
- Инструменты действия почти всегда ближе к инструментам записи;
