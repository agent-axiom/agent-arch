...
- какие изменения вообще считать release-bearing;
...
Эта часть отвечает именно на них. Она читает agent system уже не как архитектурную схему, а как governed lifecycle.
...
!!! info "Короткий маршрут по этой части"
    ...
    - [Глава 20](chapter-20.md): понять, какие изменения считать release-bearing;
...
- показывает agent system как governed lifecycle, а не как одноразовый launch;
