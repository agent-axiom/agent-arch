...
The classifier enumerates supported change surfaces explicitly. An empty or unknown surface does not become low risk: it returns `review_required` until an owner extends the schema and its checks.
