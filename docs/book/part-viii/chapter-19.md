...
То есть новый жизненный цикл появляется не потому, что “агенты особенные”, а потому, что у них больше подвижных поверхностей, которые нужно выпускать и контролировать.
...
Если назвать это моделью жизненного цикла, появляются более взрослые вопросы:
