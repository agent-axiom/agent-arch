...
Для agent systems это особенно важно, потому что они обычно оставляют за собой длинный operational хвост:
...
То есть retirement здесь — это не “удалили сервис и забыли”. Это управляемый operational процесс.

## 2. Когда вообще пора думать о retirement

Очень полезно перестать воспринимать retirement как нечто далекое и неприятное.
...
Одна из самых неприятных operational ошибок выглядит так:
...
Хороший end-of-life process редко выглядит как одно действие. Обычно его полезно раскладывать по слоям:
...
- отключить background jobs;
- отозвать egress access;
- закрыть principals, secrets и connectors;
- зафиксировать final audit state.

<div class="diagram-card">
<p>Retirement лучше делать как последовательное сужение operational surface</p>
...
То есть retirement затрагивает не только running system, но и исторический operational footprint.
...
Очень полезно иметь не только `approved inventory`, но и `deprecated inventory`.
...
- Ясно ли, что делать с memory, traces и approvals после shutdown?
