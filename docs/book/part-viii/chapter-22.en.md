...
**Supply-chain case-spine note:** the approved artifact bundle should preserve provenance for all three canonical cases. Support triage needs the [eval dataset](../../appendix/eval-schema.en.md), [policy bundle](../../appendix/policy-bundle-schema.en.md), [capability contract](../../appendix/lifecycle-artifact-schema.en.md), [approval schema](../../appendix/approval-schema.en.md), [trace schema](../../appendix/trace-schema.en.md), and [rollout gate](../../appendix/change-rollout-schema.en.md) versions for the write path. Internal knowledge assistant needs an [approved retrieval corpus](../../appendix/memory-retrieval-schema.en.md), [source-grounding rubric, tenant-filter config, memory-write policy, and freshness attestation](../../appendix/memory-retrieval-schema.en.md). Incident coordination needs an escalation-policy bundle, notification contract, responder-role map, [incident-state schema](../../appendix/incident-record-schema.en.md), and [post-incident artifact update](../../appendix/lifecycle-artifact-schema.en.md).
