...
Теперь нужно дополнительно спрашивать:
...
Следующий логичный шаг после этой главы — не просто “еще раз посмотреть security”, а научиться проверять такие риски через behavioral evals, control evals и automated red teaming.
