...
Эта глава отвечает на один вопрос: **на какой именно проверенный набор артефактов потом опирается rollout review, incident analysis или assurance-решение**. Здесь provenance нужно не как общее слово про evidence, а как governed lineage доверенных версий и контрактов.
