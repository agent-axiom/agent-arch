...
**Registry case-spine note:** every canonical case should become a [named registry record](../../appendix/registry-operations-handbook.en.md), not a story in prose. Support triage needs write-capability owners, [approval mode](../../appendix/approval-schema.en.md), and [retirement plan](../../appendix/lifecycle-artifact-schema.en.md) for deprecated ticket paths. Internal knowledge assistant needs [corpus owners](../../appendix/memory-retrieval-schema.en.md), freshness review, tenant scope, and [retrieval-policy linkage](../../appendix/memory-retrieval-schema.en.md). Incident coordination needs incident-role owners, escalation authority, notification channels, and [lifecycle state](../../appendix/lifecycle-artifact-schema.en.md) for emergency-only capabilities.
