...
Закрыт первый пакет замечаний издательского QA: рамка принятия решений в Главе 1 переведена из таблицы в устойчивый текстовый блок для HTML/PDF/plain-text extraction, а fast-moving главы, Sources и What’s New получили свежую дату редакционной проверки.
