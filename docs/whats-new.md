...
- проверены поисковый индекс, sitemap, robots, локальные ресурсы, anchors, alt text и внешние ссылки;
...
- blocker register, waiver/decision log, ограничение длины строк и названия publisher packet устойчивы для печати и экспорта;
