...
Перед следующим деплоем закрыт publisher-facing слой качества:
...
Почему это важно: опубликованный сайт должен выглядеть как аккуратный reader-facing продукт, а не как сырая сборка из Markdown-файлов.
