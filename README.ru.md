...
- **Нейтральная к поставщикам архитектура (vendor-neutral architecture).** Книга опирается на принципы и операционные модели, которые переживут любой конкретный фреймворк или провайдера моделей.
