...
def test_whats_new_publisher_readiness_claim_stays_scoped() -> None:
    expected_by_file = {
        "docs/whats-new.md": (
            ...
            "line-length guard и labels publisher packet устойчивы для печати/export",
        ...
        "docs/whats-new.en.md": (
            ...
            "line-length guard, and labels are print/export-friendly",
        ...
        "docs/whats-new.zh.md": (
            ...
            "line-length guard 与 labels 现在都适合打印/export",
